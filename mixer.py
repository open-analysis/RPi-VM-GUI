...
from gui import MainWindow, VMRibbonWidget, VMWidgetHolder, VMAudioSettingsMenu, buildMenu
...
def start():
    ...
    menu_audio_out_device_options = buildMenu(opts_audio_output_devices, "Output Devices")
    ...
    audio_programs = []
    for opt in opts_audio_output_progs:
    ...
    menu_audio_out_program_options = buildMenu(opts_audio_output_progs_with_settings, "Output Programs")
